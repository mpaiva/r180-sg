...
(function() {
	...
	Book.prototype._initEvents = function() {
		...
		if( this.bb ) {
			this.ctrls.querySelector( 'a.bb-button:nth-child(1)' ).addEventListener( 'click', function( ev ) { ev.preventDefault(); self._open(); } );
		...
		this.ctrls.querySelector( 'a.bb-button:nth-child(2)' ).addEventListener( 'click', function( ev ) { ev.preventDefault(); self._showDetails(); } );
